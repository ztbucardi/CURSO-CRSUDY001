RBPDFFontDescriptor.define('hysmyeongjostdmedium') do |font|
  ...
  font[:desc]={'Ascent'=>880, 'Descent'=>-120, 'CapHeight'=>720, 'Flags'=>6, 'FontBBox'=>'[-28 -148 1001 880]', 'ItalicAngle'=>0, 'StemV'=>60, 'Style'=>'<< /Panose <000000000600000000000000> >>'}
  font[:cidinfo]={'Registry'=>'Adobe', 'Ordering'=>'Korea1', 'Supplement'=>'1'}
  font[:enc]='UniKS-UCS2-H'
