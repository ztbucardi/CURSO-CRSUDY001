RBPDFFontDescriptor.define('msungstdlight') do |font|
  ...
  font[:desc]={'Ascent'=>880, 'Descent'=>-120, 'CapHeight'=>880, 'Flags'=>6, 'FontBBox'=>'[-160 -249 1015 1071]', 'ItalicAngle'=>0, 'StemV'=>93}
  font[:cidinfo]={'Registry'=>'Adobe', 'Ordering'=>'CNS1', 'Supplement'=>'3'}
  font[:enc]='UniCNS-UCS2-H'
  font[:up]=-130
  font[:ut]=40
  font[:dw]=1000
  font[:cw]={
