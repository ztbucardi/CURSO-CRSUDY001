RBPDFFontDescriptor.define('stsongstdlight') do |font|
  font[:type]='cidfont0'
  font[:name]='STSongStd-Light-Acro'
  font[:displayname]='STSong Light (Simp. Chinese)'
  font[:desc]={'Ascent'=>752, 'Descent'=>-271, 'CapHeight'=>737, 'Flags'=>6, 'FontBBox'=>'[-25 -254 1000 880]', 'ItalicAngle'=>0, 'StemV'=>58, 'Style'=>'<< /Panose <000000000400000000000000> >>'}
  font[:cidinfo]={'Registry'=>'Adobe', 'Ordering'=>'GB1', 'Supplement'=>'2'}
  font[:enc]='UniGB-UCS2-H'
